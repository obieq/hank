...
var app = angular
  ...
  .constant('ngAppSettings', {
    ...
    WebSiteTestCasesUrl: "WebSite/{0}/test-case",
    WebSiteSchedulerUrl: "WebSite/{0}/scheduler",
    WebSiteSharedTestUrl: "WebSite/{0}/shared-test-case",
    ...
    TestCatTestScriptsUrl: "WebSite/{0}/test-cat/{1}/test-scripts",

    SchedulerUrl: "Scheduler",
    SchedulerSuiteUrl: "Scheduler/{0}/scheduler-suite-map",
    SchedulerHistoryUrl: "Scheduler/{0}/scheduler-history",
    SchedulerForceExecuteUrl: "Scheduler/{0}/force-execute",
    ...
    PagesUrl: "Pages",
    PagesLocatorIdentifierUrl: "Pages/{0}/locator-identifier",
    LocatorIdentifierUrl: "locator-identifier",

    TestUrl: "Test",
    TestQueueUrl: "TestQueue",
    TestDataAllByTestIdUrl: "test/{0}/test-data",
    TestDataGetVariableTestSteps: "test/{0}/variable-test-steps",
    TestDataGetVariableForAutoComplete: 'test/{0}/variable-for-autocomplete',
    TestDataUrl: "TestData",
    TestDataListAddUrl: "test-data/copy-test-data",
    SuiteUrl: "Suite",
    SuiteTestMapUrl: "Suite/{0}/suite-test-map",
    SuiteTestMapBySuiteIdListUrl: "Suite/suite-test-map/{0}",
    WebsiteSharedTestCasesUrl: "WebSite/{0}/shared-test-case",
    SharedTestUrl: "sharedtest",
    SharedTestDataAllBySharedTestIdUrl: "sharedtest/{0}/shared-test-data",
    SharedTestDataGetVariableTestSteps: "sharedtest/{0}/variable-test-steps",
